...
CREATE SEQUENCE IF NOT EXISTS genders_id_seq START WITH 1 INCREMENT BY 1;

-- Tablas (sintaxis H2 compatible)
CREATE TABLE IF NOT EXISTS sizes (
                                     id BIGINT DEFAULT nextval('sizes_id_seq') PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS genders (
                                          id BIGINT DEFAULT nextval('genders_id_seq') PRIMARY KEY,
                                          name VARCHAR(50) NOT NULL
);
...
ALTER SEQUENCE genders_id_seq RESTART WITH 2;
...
CREATE TABLE IF NOT EXISTS products (
                                        ...
                                        gender_id BIGINT NOT NULL REFERENCES genders(id) ON DELETE RESTRICT,
                                        description TEXT,
...
CREATE INDEX IF NOT EXISTS idx_products_genders_id ON products(gender_id);